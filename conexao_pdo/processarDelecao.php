...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$id) {
        echo '<div class="mensagem erro" id="msg">Erro: ID inválido.</div>';
    } else {
        ...
        try {
            $stmt->execute();
            echo '<div class="mensagem sucesso" id="msg">Cliente excluído com sucesso!</div>';
        } catch (PDOException $e) {
            error_log("Erro ao excluir cliente: " . $e->getMessage());
            echo '<div class="mensagem erro" id="msg">Erro ao excluir cliente.</div>';
        }
    }
}
?>
